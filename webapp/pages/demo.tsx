          ...
          {completed ? (
            ...
            <div className="h-full w-full items-center flex flex-col mt-[10vh]">
                ...
                >
                  ...
                  Please tell us the concept you'd like to simplify, and we'll turn it into a catchy rhyme that you can easily remember. Learning has never been this enjoyable and straightforward.
                  </p>
                  <div>
                    <RadioGroup value={selected} onChange={setSelected}>
                      ...
                      <textarea class="w-full" rows="5" cols="40" placeholder="Enter the concept you want to simplify... for example... what is electrolysis?"/>
                      </div>
                    </RadioGroup>
                  </div>
